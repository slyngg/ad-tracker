...
exports.pollCheckoutChamp = pollCheckoutChamp;
...
async function pollCheckoutChamp() {
    ...
    for (const order of orders) {
        ...
        try {
         ...
         ON CONFLICT (order_id) DO UPDATE SET
           ...
           quantity = EXCLUDED.quantity`, [orderId, offerName, total, subtotal, tax, orderStatus, newCustomer, utmCampaign, fbclid, subscriptionId, quantity]);
            inserted++;
        }
        catch (err) {
...
//# sourceMappingURL=cc-polling.js.map